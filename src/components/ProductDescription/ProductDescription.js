    ...
    return (
        <div className={cx('prod-content')}>
            <div className={cx('row')}>
                <div
                    className={cx(
                        'col-12 col-xxl-8 col-xl-8 col-lg-10 col-md-12',
                    )}
                >
                    <div className={cx('text-content')}>
                        ...
                        <p>
                            Ít đắng, ít đậm, vị thanh chua nhẹ nhàng kiểu vị trái cây, ít cafeine. Loại này Tây khá
                            thích, hợp với pha phin loãng, Cold Brew, French Press.
                        </p>
                        <p>
                        ...
                        <p>
                            Vị đắng nhưng dịu hơn, thanh hơn vị Truyền thống. Túi này mix giữa Đen và Trắng, nhưng
                            nghiêng về phần đậm của màu đen nhiều hơn.
                        </p>
                        <p>
