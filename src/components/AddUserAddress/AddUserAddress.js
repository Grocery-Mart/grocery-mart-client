            ...
            <div className={cx('form__row')}>
              <div className={cx('form__group')}>
                ...
                <div className={cx('form__text-input', 'form__text-input--sm')}>
                  <input type="text" id="name" name="name" placeholder="Họ tên" className={cx('form__input')} />
                </div>
              </div>
              <div className={cx('form__group')}>
                ...
                <div className={cx('form__text-input', 'form__text-input--sm')}>
                  <input id="phone" type="tel" name="phone" placeholder="Điện thoại" className={cx('form__input')} />
                </div>
              </div>
            </div>
            <div className={cx('form__group')}>
