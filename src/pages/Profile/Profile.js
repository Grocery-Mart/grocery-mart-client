                                ...
                                <div className={cx('profile-menu')}>
                                    ...
                                    <ul className={cx('profile-menu__list')}>
                                        <li>
                                            <a
                                                href="#!"
                                                className={cx('profile-menu__link')}
                                                onClick={() => setType('personalInfo')}
                                            >
                                        ...
                                        <li>
                                            <a
                                                href="#!"
                                                className={cx('profile-menu__link')}
                                                onClick={() => setType('changePassword')}
                                            >
                                                <span className={cx('profile-menu__icon-wrap')}>
                                ...
                                <div className={cx('profile-info')}>
                                    <div className={cx('row gy-5')}>
                                        <div className={cx('col-12')}>
                                            ...
                                            <div
                                                className={cx(
                                                    'row gy-4 row-cols-1 row-cols-xxl-3 row-cols-xl-3 row-cols-lg-2',
                                                )}
                                            >
                                                <div className={cx('col')}>
                                                    <article
                                                        className={cx('payment-card')}
                                                        style={{ '--payment-card-bg': '#1e2e69' }}
                                                    >
                                                        <img
                                                            src={images.BankCart}
                                                            alt=""
                                                            className={cx('payment-card__img')}
                                                        />
                                                        <div className={cx('payment-card__top')}>
                                                            <BankCartIcon />
                                                            <span className={cx('payment-card__type')}>
                                                                Techcombank
                                                            </span>
                                                        </div>
                                        ...
                                        <div className={cx('col-12')}>
                                            ...
                                            <p className={cx('profile-info__desc')}>
