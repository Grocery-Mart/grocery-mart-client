                        ...
                        {currentUser ? (
                            <div className={cx('action')}>
                                ...
                                <div className={cx('action__user')}>
                                    <img src='https://wx4.sinaimg.cn/mw690/001Pb9yIgy1hl9fqj7mkuj62te4804qu02.jpg' alt='avatar' className={cx('action__avatar')}/>
                                </div>
                            </div>
                        ) : (
                            <>
                                <Button text rightIcon={<FontAwesomeIcon icon={faSignIn}/>}>Đăng nhập</Button>
